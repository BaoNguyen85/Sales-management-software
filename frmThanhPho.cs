    ...
    public partial class frmThanhPho : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if(Them)
            {
                try
                {
                    //Thêm điều kiện nhập khác rỗng
                    if (this.txThanhPho.Text.ToString() != string.Empty
                        && this.txtTenThanhPho.Text.ToString() != string.Empty)
                    {
                        //Thực hiện lệnh
                        SqlCommand cmd = new SqlCommand();
                        cmd.Connection = conn;
            ...
            if(!Them)
            {
                try
                {
                    //Thêm điều kiện sửa khác rỗng
                    if (this.txtTenThanhPho.Text.ToString() != string.Empty)
                    {
                        //Thực hiện lệnh
                        SqlCommand cmd = new SqlCommand();
                        cmd.Connection = conn;
