    ...
    public partial class frmKhachHang : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if(Them)
            {
                try
                {
                    //Thêm điều kiện nhập mã khách hàng khác rỗng 
                    if (this.txtMaKH.Text.ToString() != string.Empty
                        && this.txtTenCty.Text.ToString() != string.Empty)
                    {
                        //Thực hiện lệnh
                        SqlCommand cmd = new SqlCommand();
                        cmd.Connection = conn;
            ...
            if(!Them)
            {
                try
                {
                    //Thêm điều kiện tên công ty khác rỗng 
                    if (this.txtTenCty.Text.ToString() != string.Empty)
                    {
                        //Thực hiện lệnh
                        SqlCommand cmd = new SqlCommand();
                        cmd.Connection = conn;
